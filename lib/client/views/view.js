...
function View(model, container, opts) {
  ...
  if(this.constructor.templateUrl) {
    this.replace = true
    this.view = new LiveView(this.constructor.templateUrl, init, function() {}, scope)
    // if the container is a jQuery thing
  } else if(this.container instanceof $) {
    this.view = new LiveView(this.container, init, function() {}, scope) 
